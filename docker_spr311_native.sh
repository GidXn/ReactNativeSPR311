...
server_up() {
    echo "Server up..."
    docker pull GidXn@ReactNativeSPR311/spr311-api:latest
    docker stop spr311-api_container || true
    docker rm spr311-api_container || true
    docker run -d --restart=always -v /volumes/spr311-api/images:/app/images --name spr311-api_container -p 4378:8080 GidXn@ReactNativeSPR311/spr311-api
}
